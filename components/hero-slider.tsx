        ...
        {slides.map((slide, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="relative mx-auto flex h-full min-h-[560px] w-[min(1310px,92vw)] flex-col justify-between pt-14 pb-28 md:min-h-[640px] md:py-20">
                <div>
                ...
                <div className="mb-16 flex flex-wrap gap-3 md:mb-0">
