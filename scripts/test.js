...
assertContains(i18nMessages, "parkingMapTitle: 'Mapa parkovania aut'", 'lib/i18n/messages.ts');
assertContains(i18nMessages, "buffetMapTitle: 'Mala mapa k Bufetu na dobrom mieste'", 'lib/i18n/messages.ts');
